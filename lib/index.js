 ...
 * const object = { a: { b: null, c: { value: 42 } } };
 * 
 * getWithDefault(object, 'a', 'c', 'value'); // => 42
 * getWithDefault(object, 'a', 'b', 'value'); // => undefined
 * ```
 */
 ...
 * nthWithDefault('default', list, 3); // => 'defaultValue'
 * ```
 */
 ...
 * const list = ['first', 'second', 'third'];
 * 
 * nthWithDefault(list, 1); // => 'second'
 * nthWithDefault(list, 3); // => undefined
 * ```
 */
 ...
 * const list = ['first', 'second', 'third'];
 * 
 * headWithDefault('default', list, 1); // => 'second'
 * headWithDefault('default', [], 3); // => 'defaultValue'
 * ```
 */
 ...
 * const list = ['first', 'second', 'third'];
 * 
 * head('default', list, 1); // => 'second'
 * head('default', [], 3); // => undefined
 * ```
 */
function head(list) {
