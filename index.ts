...
export interface IGet {
	<T extends object, Key1 extends keyof T>(object: T, key1: Key1): undefined | T[Key1];
	<T extends object, Key1 extends keyof T, Key2 extends keyof T[Key1]>
...
export interface IProperty {
	<T extends object, Key1 extends keyof T>(key1: Key1)
...
export interface IGetWithDefault {
	<Default, T extends object, Key1 extends keyof T>(defaultValue: Default, object: T, key1: Key1): Default | T[Key1];
	<Default, T extends object, Key1 extends keyof T, Key2 extends keyof T[Key1]>
